    ...
    public class ArticleMapping : Profile
    {
        public ArticleMapping()
        {
            CreateMap<ArticleEntity, Article>()
                ...
                .ForMember(destination => destination.PriceAmount, option => option.MapFrom(source => source.price.amount))
                .ForMember(destination => destination.PriceOldAmount, option => option.MapFrom(source => source.price.old_amount))
